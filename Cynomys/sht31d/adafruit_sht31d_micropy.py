...
Adapted for MicroPython by Ryan T. Hamilton which removed the BusDevice 
dependency and just uses the native machine.I2C versions
"""
...
class SHT31D:
    ...
    :param i2c_bus: The `machine.I2C` object to use. This is the only 
                    required parameter.
    ...
    def _command(self, command):
        self.i2c_bus.writeto(self._address, struct.pack(">H", command))
    ...
    def _data(self):
        ...
        self.i2c_bus.readfrom_into(self._address, data)
    ...
    def mode(self):
        ...
        Return the device to 'Single' mode to stop periodic data acquisition 
    ...
    def relative_humidity(self):
        ...
        'Periodic' mode returns the most recent readings available from the 
        sensor's cache in a FILO list of eight floats. This list is backfilled 
        with with the sensor's maximum output of 100.01831417975366 when the 
        sensor is read before the cache is full.
        """
